...
| Deployment error fix | Moved Storage static website enablement out of ARM and into the GitHub Actions workflow, then passed the resolved website endpoint into Bicep for the app config | Passed local Bicep validation | Current session |
